class Persona {
    ...
    constructor( nombre, apellido ) {
        ...
        if( Persona.contadorPersonas < Persona.MAX_OBJECTS ) {
...
let persona3 = new Persona( "Octavio", "Perez", "Dr." );
console.log( persona3.toString() );

let persona4 = new Persona( "Javier", "Hernandez", "Mtro." );
console.log( persona2.toString() );

let persona5 = new Persona( "Victor", "López", "Ing." );
console.log( persona5.toString() );

let persona6 = new Persona( "Sara", "Salas", "Ing." );
console.log( persona6.toString() );

console.log( Persona.MAX_OBJECTS );
